		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#startuitestworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"startuitestworkflowuimodule-display": {
								"semanticObject": "startuitestworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=startuitest.workflowuimodule",
									"url": sap.ui.require.toUrl("startuitest/workflowuimodule")
								}
							}
						}
					}
