		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ApproveFormapproveform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ApproveFormapproveform-display": {
								"semanticObject": "ApproveFormapproveform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ApproveForm.approveform",
									"url": sap.ui.require.toUrl("ApproveForm/approveform")
								}
							}
						}
					}
